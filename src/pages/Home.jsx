export default function Home() {
  return (
    <div className="max-w-4xl px-6 mx-auto text-left">
      ...
      <p className="text-slate-300 max-w-xl leading-relaxed">
        ...
        I love building clean interfaces and learning new tools. Currently diving deep into React, TypeScript, and design systems.
      </p>
    </div>
  )
}